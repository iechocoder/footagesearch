...
?>
<div style="width:100%;">
<div class="footagesearch-preview-prev-next clip-video-left">
    <div id="footagesearch-clip-<?php echo $clip['id']; ?>" class="footagesearch-preview-clip"
		...
		?>
          ...
          <meta itemprop="contentURL" content="<?php echo $videolink[0]; ?>" />
          ...
          <meta itemprop="width" content="360px" />
            ...
            <span itemprop="description" style="display:none;"><?php echo $clip['description']; ?> </span>  
          </div>
 ...
 <div itemprop="video" itemscope itemtype="http://schema.org/VideoObject">
        ...
        ?>
            ...
            if (!is_user_logged_in()) {
                ?>
                <div class="footagesearch-clip-cart-clipbin-actions" style="padding-top:12px;">
                    <?php
                    ...
                    <div id="tutorial-<?php echo $clip['id']; ?>" class="heartPosition">
                        ...
                        if (!empty($userLoginId_grid)) {
                            ...
                            <?php } else {
                                ?>
                                <div class="inner_like transitiable"><a rel="nofollow" href="javascript:void(0)"
...
//                        if (mysql_num_rows($result) < 5) {
                        echo '<a rel="nofollow" class="preview_download" data-clip-id="' . $clip['id'] . '"  href="' . (function_exists('clip_preview_download_link') ? clip_preview_download_link($clip['id']) : $clip['download']) . '"><img src="' . get_template_directory_uri() . '/images/download_icon.png" alt=""></a>';
                        //  } else {
    ...
    <h2 style=" display:block; text-transform:capitalize;"><?php _e('Clip Details', 'footagesearch'); ?></h2>
...
<?php if ($clip['active'] == 1) { ?>
    <div
        ...
        <table style="width: 100%;">
            <tr>
                <th colspan="2" style="text-align: left;"><h2 style="font-weight:normal;">Pricing Calculator:</h2></th>
            </tr>
            <tr>
            ...
            <?php if ($clip['license'] != 1) { ?>
                <tr>
                    ...
                    <td width="700"><span
                            class="footagesearch-license-description-cont-popup"><?php echo $license_description ?></span>
                    </td>
                </tr>
            ...
            <tr>
                ...
                <td width="700"><span
                        class="footagesearch-license-restrictions-popup"><?php echo $license_restrictions ?></span></td>
            </tr>
        </table>
    </div>
            ...
            <table style="width: 100%">
                ...
                <tr>
                    ...
                    <td><?php //var_dump([$format,$method,$clip]);                  ?>
                        ...
                        <div style="display: block; color:#FFF;" data-use="8">
                        <p style="color:#FFF;">
                        <strong>Bulk Discounts:</strong><br>
                        <span>&gt;1 Minute, 10% Discount</span><br>
                        <span>&gt;2 Minutes, 15% Discount</span><br>
                        <span>&gt;3 Minutes, 20% Discount</span><br>
                        <span>&gt;5 Minutes, Please Inquire</span><br><br>
                        <span>Bulk discounts are calculated automatically in the Cart. A Non-Profit discount of 10% is available, but can not be combined with any other discounts. Do you (or your affiliated organization) license large quantities of footage throughout the year? If so, contact us to learn more about our Preferred Client Discount Program.</span></p></div>
                    </td>
